...
The web UI and the CLI are two doors to the same workforce. Everything below is
available after installing the CLI — `curl -fsSL https://openacme.pages.dev/install.sh | sh`,
or `npm install -g @openacme/cli`.
